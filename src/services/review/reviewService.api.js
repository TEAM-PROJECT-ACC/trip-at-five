...
export const getAccomLatestReviewAPI = async (accomNo) => {
  const response = await apiAxios.get(`/api/reviews/accommodation/${accomNo}/latest`);
  return response.data;
};
...
export const getAccomReviewAverageScoreAPI = async (accomNo) => {
  const response = await apiAxios.get(`/api/reviews/accommodation/${accomNo}/average`);
  return response.data;
};

export const getAccomReviewCountAPI = async (accomNo) => {
  const response = await apiAxios.get(`/api/reviews/accommodation/${accomNo}/count`);
  return response.data; 
};