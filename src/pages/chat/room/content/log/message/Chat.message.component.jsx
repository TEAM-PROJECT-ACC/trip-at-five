import ChatItemText from '../../content-item/chat-text/Chat.text.component';
import './chat.message.component.scss';

export function ChatUserMessage() {
	const msg1 =
		'개인 사정이 생겨서 예약 취소 하려고 합니다.취소좀 해주시겠어요? ';

	return (
		<div className='chat-Transparent-wrap'>
			<div className='chat-user-messgae-wrap'>
				<ChatItemText
					className={'chat-user-nickName'}
					text={'사용자'}
				/>
