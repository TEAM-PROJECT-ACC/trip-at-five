...
export default function PwdRestting() {
    ...
    return (
        ...
        <PageContainer>
            ...
            <ResttingTitle className={'resetting-title'} text={'비밀번호 재설정'}/>
            {/* <ResttingTitle className={'resetting-Description'} text={'비밀번호를 재설정 하기 위해 이메일을 입력해주세요'}/> */}
            <ResttingTitle className={'resetting-Description '} text={'한글을 제외한 영문, 숫자, 특수문자를 포함한 8자 이상'}/>
